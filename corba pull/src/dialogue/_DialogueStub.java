...
public class _DialogueStub extends org.omg.CORBA.portable.ObjectImpl implements dialogue.Dialogue
{
  ...
  public void sendMessage (String from, String to, String message) throws dialogue.DialoguePackage.notExistingPseudo
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:dialogue/Dialogue/notExistingPseudo:1.0"))
                    throw dialogue.DialoguePackage.notExistingPseudoHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
